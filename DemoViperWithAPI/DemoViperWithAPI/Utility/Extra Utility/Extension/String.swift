...
extension String {
    ...
    var withoutSpecialCharacters: String {
        var str = self
        str = str.components(separatedBy: CharacterSet.symbols).joined(separator: "")
        str = str.components(separatedBy: CharacterSet.punctuationCharacters).joined(separator: "")
        str = str.components(separatedBy: CharacterSet.symbols).joined(separator: "")
        return str
    }
    ...
    func isValidateEmail1(candidate: String) -> Bool {
