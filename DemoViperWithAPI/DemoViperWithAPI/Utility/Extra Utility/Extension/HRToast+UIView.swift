...
// shadow appearance
let HRToastShadowOpacity  : CGFloat   = 0.9
...
let HRToastCornerRadius   : CGFloat   = 4.0
...
//        activityView.layer.cornerRadius = HRToastCornerRadius
        ...
        if HRToastDisplayShadow {
            ...
            activityView.layer.shadowColor  = UIColor.darkGray.cgColor
...
//        wrapperView.addShadowin_All_Side()
...
//        }
        ...
        if msgLabel != nil {
            msgLabel!.frame = CGRect(x: msgLeft, y: (wrapperHeight - msgHeight)/2, width: msgWidth, height: msgHeight)
